...
<%
	...
	try {
		...
		ResultSet rs = stmt
				.executeQuery("Select * from clients as e where e.client_id='"
						+ id + "' AND e.client_type='exist'");
		ResultSet rs2 = stmt2
				.executeQuery("Select * from client_comm as ec where ec.client_id='"
						+ id + "'");
		ResultSet rs3 = stmt3
				.executeQuery("Select * from file_attachments as ea where ea.client_id='"
						+ id + "'");
%>
<body bgcolor="#94B8FF">
	...
	<center>
		<b><font size="5">To upload a file &nbsp;<a
				href="existFileUpload.jsp?id=<%=id%>"><strong>Click
	...
	<table align="center" border="1">
		...
		<tr>
			...
			<td align="center"><a
				href="editExistComm.do?id=<%=rs2.getInt("comm_id")%>">EDIT</a></td>
		</tr>
		<%
			}
		%>
