...
<body bgcolor="#94B8FF">
	...
	<br>
	<center>
		Want to add a new client?? <a href="addExisting.jsp">Click Here!!</a>
	</center>
	<center>
		<form name="searchForm" method="get" action="searchExisting.do">
			<table>
				<tr>
			...
			<table>
				<tr>
					...
					<td><input type="submit" name="search" value="SEARCH in EC" /></td>
				</tr>
			</table>
		</form>
		<%
		...
		%>
		<form action="MoveServletEP" method="post" name="moveEP">
			<table align="center" border="1" cellpadding="10px">
				<tr>
					...
					<th>Sector of the Assignment</th>
					<th>Year in which the assignment was taken</th>
				...
				<c:forEach items="${ existclient }" var="client1">
					<tr>
						...
						<td align="center"><a
							href="existingclientinfo.jsp?id=<c:out value="${ client1.id }"></c:out>"><c:out
						...
						<td align="center"><c:out value="${ client1.assignment }"></c:out></td>
						<td align="center"><c:out value="${ client1.assignsector }"></c:out></td>
						<td align="center"><c:out value="${ client1.assignyear }"></c:out></td>
						...
						<td align="center"><a
							href="editExistClient.do?id=<c:out value="${ client1.id }"></c:out>">Edit</a></td>
						<td align="center"><a
							href="deleteExistClient.do?id=<c:out value="${ client1.id }"></c:out>">Delete</a></td>
					</tr>
				</c:forEach>
			</table>
