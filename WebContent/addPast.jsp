...
<script>
	...
	function validateForm() {
		var a = document.addPast.cname.value;
		var b = document.addPast.caddress.value;
		var c = document.addPast.cturnover.value;
		var d = document.addPast.cnoe.value;
		var e = document.addPast.cloc.value;
		var f = document.getElementById("countries").value;
		var g = document.addPast.cassgn.value;
		var h = document.addPast.cassgnsect.value;
		var i = document.getElementById("years").value;
		var j = document.addPast.poc.value;
		if (a == "" || a == null) {
			...
			alert('please enter the name of Point of Contact from your firm');
			return false;
		} else
			return true;
	}
...
<body bgcolor="#94B8FF">
	...
	<%
		Client past = (Client) request.getAttribute("pastclient");
		String name = "", address = "", turnover = "", location = "", country = "", poc = "", remdate = "", assignment = "", assignsector = "", assignyear = "", sub = "SUBMIT";
		String id;
		long noe;
	...
	%>
	<br>
	<center>Want to search a Customer???? <a href="searchPast.jsp">Click Here!!</a></center>
	<h3 align="center">Add a Past Client</h3>
	<br>
	<form name="addPast" method="get" action="addPast.do"
		...
		<table align="center">
			...
			<tr>
				<td><input type="hidden" name="type" value="past" /></td>
			</tr>
		</table>
		<table align="center">
			<tr>
	...
	<%
			...
			sub="EDIT";
			name = past.getName();
			address = past.getAddress();
			turnover = past.getTurnover();
			noe = past.getNoe();
			location = past.getLocation();
			country = past.getCountry();
			poc = past.getContactperson();
			id = past.getId();
	%>
	<h3 align="center">Edit a Past Client</h3>
	<br>
	<form name="editPast" method="get" action="updatePast.do">
