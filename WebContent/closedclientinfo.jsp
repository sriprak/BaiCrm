...
<%
	...
	try {
		...
		ResultSet rs = stmt
				.executeQuery("Select * from clients as c where c.client_id='"
						+ id + "' AND c.client_type='closed'");
		ResultSet rs2 = stmt2
				.executeQuery("Select * from client_comm as cc where cc.client_id='"
						+ id + "'");
		ResultSet rs3 = stmt3
				.executeQuery("Select * from file_attachments as ca where ca.client_id='"
						+ id + "'");
%>
<body bgcolor="#94B8FF">
	...
	<table align="center" border="1">
		...
		%>
		<tr>
			<td><a href=""><%=rs3.getBytes("file")%></a></td>
		</tr>
		<%
			}
		%>
