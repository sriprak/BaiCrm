...
<title>Edit Communications Page</title>
</head>
<body bgcolor="#94B8FF">
	<%@ include file="main.jsp"%>
	<%
		ClientCommunications future = (ClientCommunications) request
				.getAttribute("futComm");
	...
	<%
			...
			id = future.getId();
			commDate = future.getDate();
			comm = future.getComm();
			remdate = future.getRemdate();
	%>
